...
2. OSM/healthsites    | 432 | 72 | coords | (few complete) beds,staff_doctors,staff nurses
3. Health Service Functionality Dashboard | 1890 | 82 | not downloadable, (1671 with coords, 219 without) | lots e.g. functionality
4. Maina(2019) Kemri | 1734 | 40 | coords | no attributes
5. HDX latest (MoH 2016) | 1464 | 53 | coords | codes & functional status
...
gghdx <- facility_types("south sudan", 
                        ...
                        type_column = "HF_TYPE",
                        lonlat_columns = NULL,
                        plot_title="Facility types, latest on HDX (from MoH 2016)",
                        plot=FALSE)
plot(gghdx)
