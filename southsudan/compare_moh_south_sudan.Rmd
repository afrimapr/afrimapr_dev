...
1. HSF   : [South Sudan Health Service Functionality Dashboard](https://southsudanhsf.shinyapps.io/hsf_dashboard/) (locations not downloadable, licensing uncertain)
...
For now we will focus mostly on the top three, because the latter two are older.
...
Both the MoH and HSF websites have contact emails indicating that they will answer queries. We reached out to both twice in April May 2021 and received no reply.
