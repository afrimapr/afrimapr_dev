...
preg_cty_qtr <- preg %>% 
  ...
  group_by(orgunitlevel2, year, quarter, date) %>%
...
preg_cty_qtr %>%   
  ggplot(aes(x = date, y = adolescent_pregnancy, colour = orgunitlevel2)) +
  geom_line()
...
preg_cty_yr %>%   
  ggplot(aes(x = as.numeric(year), y = adolescent_pregnancy, colour = orgunitlevel2)) +
  geom_line()
