...
R code to produce figures 4 & 5 in : South (2020) A rapid and reproducible picture of open access health facility data in Africa to support the COVID-19 response. Wellcome Open Research
...
```{r fig4_points_who_hs_moh, echo=FALSE, warnings=FALSE, asis=TRUE, fig.width=9, fig.height=9}
