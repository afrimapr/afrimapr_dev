...
```{r survey2020-hospital-operating-theatre, eval=TRUE, fig.height=5, fig.width=7.5, fig.show='hold'}
...
```{r survey2020-hospital-ultrasound, eval=TRUE, fig.height=5, fig.width=7.5, fig.show='hold'}
...
```{r survey2020-hospital-icu, eval=TRUE, fig.height=5, fig.width=7.5, fig.show='hold'}
