...
DRAFT
[Code for this document](https://github.com/afrimapr/afrimapr_dev/blob/master/compare_moh_kenya.Rmd)

We currently have access to the following sources of health facility locations for Kenya.

1. a file obtained by WiGISKe 2021-04
1. downloaded from Ministry of Health website (no coordinates)
...
-------- | -------------- | ------------------ | ------------------
1. WiGISKe |  10013  | coords | Owner
2. MoH     |  12378 | Ward | Registration_number,Keph level,Owner type,Beds,Cots,Operation status,Open_weekends
3. OSM    | 2032 | coords | (few complete) beds,staff_doctors,staph nurses
...
dfosmold <- afrihealthsites('kenya',datasource = 'healthsites')
